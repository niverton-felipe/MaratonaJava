package abc.com.br.javacore.concorrencia.test;
        ...
        public void run() {
            ...
            try{
                if(reentrantLock.isHeldByCurrentThread()){
                    System.out.printf("Thread %s entrou em execução crítica %n", nome);
                    System.out.printf("%d Threads esperando na fila %n", reentrantLock.getQueueLength());
                    System.out.printf("Thread %s esperará por 2 segundos %n", nome);
                    Thread.sleep(2000);
